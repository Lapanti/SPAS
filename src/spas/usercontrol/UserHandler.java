...
public class UserHandler {
	...
	/**
	 * Check to see if given user is correct one. Session id is here for
	 * security purposes.
	 * 
	 * @see UserLoginHandler#validateUser(String, String) XML-perspective.
	 * @param username
	 *            User's registered login name.
	 * @param id
	 *            User's current session id.
	 * @return <code>true</code>, if and only if, user is correct.
	 */
	public boolean validateUser(String username, String id) {

		// See handler's userExists()-method for details.
		return handler.validateUser(username, id);
	}

	/**
	 * Logs user's session-id into file.
	 * 
	 * @see UserLoginHandler#changeSessionId(String, String) XML-perspective.
	 * @param username
	 *            User's registered login name.
	 * @param id
	 *            User's current session id.
	...
	public boolean logIn(String username, String id) {
		...
		// See handler's changeSessionId-method for details.
		return handler.changeSessionId(username, id);
	}

	/**
	 * Logs user out. Removes user's session-id from file.
	 * 
	 * @param username
	 *            User's registered login name.
	 * @return <code>true</code>, if and only if, nothing went wrong.
	...
	public boolean logOut(String username) {
		...
		// See handler's changeSessionId-method for details.
		return handler.changeSessionId(username, "");
	}
